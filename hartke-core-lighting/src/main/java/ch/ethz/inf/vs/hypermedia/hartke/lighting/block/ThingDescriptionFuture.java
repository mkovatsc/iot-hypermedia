 ...
 */
public class ThingDescriptionFuture extends CoREAppResourceFuture<ThingDescription> {

	public LightingConfigFuture getLightingConfig() {
		return follow(LightingConfigFuture::new, "config");
	}
