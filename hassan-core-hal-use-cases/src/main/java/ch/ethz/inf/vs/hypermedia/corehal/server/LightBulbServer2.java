 ...
 */
public class LightBulbServer2 extends CoapServer {

	public static final String LIGHTING_CONTEXT = "illumination";
	public static final String POWER_CONTEXT = "energy";
	...
	public LightBulbServer2(boolean test) {
		if (test) {
		...
		if (!test) {
			led = new DevicePanel(getClass().getResourceAsStream("bulb.png"), 280, 480) {
				@Override
	...
	public static void main(String[] args) throws Exception {
		...
		thingserver.setName("Light Bulb");
		thingserver.start();
		thingserver.register();
		// create server
		CoapServer server = new LightBulbServer2(false);
		server.start();
		...
		System.out.printf(LightBulbServer2.class.getSimpleName() + " listening on port %d.\n", port);
	}
